		...
		<div class="pt20 clearFloat">
			...
			<div class="fl ml100 main">
				...
				<div class="segmentationAbout" id="hire">
					<hr class="bfe"> <div class="num2"> </div>
				</div>
				<div class="mt30 occupation" >
					<ul>
						<li class="singleLine fold">
							...
							<div class="occuSpec">
								...
								<div class="postResume">
									<a class="m0a" href="http://www.lagou.com/jobs/179232.html ">投递简历</a>
								</div>
							</div>
						</li>
						<li class="singleLine fold" style="border-bottom:none;">
							...
							<div class="occuSpec">
								...
								<div class="postResume">
									<a class="m0a" href="http://www.lagou.com/jobs/138630.html">投递简历</a>
								</div>
							</div>
						</li>
					</ul>
				</div>
				<div class="segmentationAbout" id="report">
					<hr class="dae"> <div class="num3"> </div>
				</div>
				<div class="newPanel clearFloat">
					...
					<div class="fr mt20 mb20 pageTurn clearFloat">
						<span class="fl"></span>
						<ul class="fl">
							<li>
